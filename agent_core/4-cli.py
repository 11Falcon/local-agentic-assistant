...
# sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "tool_calling"))
...
# --- make the course root and tool_calling importable, whatever folder you run from ---
ROOT = Path(__file__).resolve().parents[1]
sys.path.insert(0, str(ROOT))                          # lets us import core.*
sys.path.insert(0, str(ROOT / "tool_calling"))    # lets us import "1-calculator"
...
def build_registry():
    """Register the tool_calling calculator as a tool the agent can call."""
