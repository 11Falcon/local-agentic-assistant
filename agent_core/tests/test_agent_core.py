"""Checks for agent_core. DO NOT EDIT."""
import pytest
...
CORE_HINT = "create core/__init__.py and the file this test asks for at the COURSE ROOT (not inside agent_core/)"
...
def _make_registry():
    ...
    calc = kit.load_task("tool_calling", "1-calculator.py")
...
def test_task_4_cli_file_exists():
    ...
    assert path.exists(), "create agent_core/4-cli.py with a main() REPL"
