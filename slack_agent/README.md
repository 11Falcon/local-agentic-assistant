...
channel* is public and instant. Notice the pattern across the service agents: read tools are
...
Verified by [`tests/test_slack_agent.py`](tests/test_slack_agent.py) — `python checker.py slack_agent`
