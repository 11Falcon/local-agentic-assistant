# Orchestration: many agents, one assistant
...
one-of-N label out. You already know how to harden it the same way you hardened structured output: constrain it,
...
as a bonus in the final project.
...
**Only when a task sends you there:** nothing external — the router is structured output
...
Verified by [`tests/test_orchestrator.py`](tests/test_orchestrator.py) — `python checker.py orchestrator`
